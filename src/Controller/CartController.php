...
final class CartController
{
    ...
    public function addItem(Request $request): JsonResponse
    {
        ...
        return new JsonResponse($result, $result->changed ? Response::HTTP_OK : Response::HTTP_UNPROCESSABLE_ENTITY);
    }
    ...
    public function updateItem(Request $request, int $id): JsonResponse
    {
        ...
        return new JsonResponse($result, $result->changed ? Response::HTTP_OK : Response::HTTP_NOT_FOUND);
    }
    ...
    private function resolveCart(Request $request): Cart
    {
        ...
        return $this->cartRepository->findActiveByToken($cartToken) ?? $this->mutationService->create('USD');
    }
}
